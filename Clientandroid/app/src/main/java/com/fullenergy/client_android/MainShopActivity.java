        ...
        try {
            ...
            clientOkHttp.newCall(request).enqueue(new Callback() {
                ...
                @Override public void onResponse(@NonNull Call call, @NonNull Response response) throws IOException {
                  //  try {
                    try {
                        JSONObject data = (JSONObject) new JSONObject(response.body().string());
                        JSONArray items = data.getJSONArray("items");
                        Log.i("APi Response in shop", "Response: " + String.valueOf(response));
                        Log.i("APi Response in shop", "Items Array: "+ String.valueOf(items));
                        ...
                        runOnUiThread(new Runnable() {
                            ...
                            private void render(final List<ProductClass> products){
                                RecyclerView rv = (RecyclerView)findViewById(R.id.shop_recyclerview2);
                                ...
                                public void onBindViewHolder(@NonNull ProductViewHolder holder, int position) {
                                    ...
                                    holder.itemView.setOnClickListener(new View.OnClickListener() {
                                        ...
                                        public void onClick(View view) {
                                            //Intent browserIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://splendid-starfish-95.loca.lt"));
