    ...
    <div className="container">
        ...
        <Form onSubmit={onSubmit}>
            <FormGroup row>
                ...
                <Col sm={6}>
                <Input id="Name" name="name" placeholder="exampleName" type="text"/>
                </Col>
            </FormGroup>
            <FormGroup row>
                <Label for="Surname" sm={1} >Surname</Label>
                <Col sm={6}>
                <Input id="Surname" name="surname" placeholder="exampleSurname" type="text"/>
                </Col>
            </FormGroup>
            <FormGroup row>
            ...
            <FormGroup row>
                ...
                <Col sm={6}>
                <Input id="Address_1" name="address_1" placeholder="Street, #, Locality, City, Postal Code" type="text"/>
                </Col>
            </FormGroup>
            <FormGroup row>
                <Label for="Address_2" sm={1} >Address_2</Label>
                <Col sm={6}>
                <Input id="Address_2" name="address_2" placeholder="Continuation Street, #, Locality, City, Postal Code" type="text"/>
                </Col>
            </FormGroup>
            <FormGroup row>
                <Label for="is_admin" sm={1} >is_admin</Label>
                <Col sm={6}>
                <Input id="is_admin" name="is_admin" placeholder="false" type="text"/>
                </Col>
            </FormGroup>
            <FormGroup row>
                <Label for="image_url" sm={1} >image_url</Label>
                <Col sm={6}>
                <Input id="image_url" name="image_url" placeholder="http://www.someurlwherephotois.com" type="text"/>
                </Col>
            </FormGroup>
